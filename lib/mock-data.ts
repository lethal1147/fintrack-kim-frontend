...
export const accounts: Account[] = [
  ...
  // Loans
  { id: "ac5", name: "Auto Loan", institution: "Toyota Financial", type: "loan", balance: -9800.0 },
  // Investments
  { id: "ac6", name: "Roth IRA", institution: "Fidelity", type: "investment", balance: 24580.0 },
  { id: "ac7", name: "401(k)", institution: "Vanguard", type: "investment", balance: 38400.0 },
]
...
export const categoryStats: CategoryStat[] = [
  { category: "Housing", total: 1200.0, pct: 57.0, color: "var(--chart-1)" },
  ...
  { category: "Health", total: 73.5, pct: 3.5, color: "var(--chart-5)" },
  { category: "Transport", total: 94.25, pct: 4.5, color: "var(--chart-1)" },
  { category: "Education", total: 39.0, pct: 1.8, color: "var(--chart-2)" },
